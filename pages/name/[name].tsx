      ...
      <Grid.Container css={{ marginTop: '5px' }} gap={2} >
        ...
        <Grid xs={12} sm={8} >
          ...
          <Card  >
            ...
            <Card.Header  css={{ display: 'flex', justifyContent: 'space-evenly', flexWrap: 'wrap', alignItems: 'center' }} >
...
export const getStaticPaths: GetStaticPaths = async (ctx) => {
  ...
  const All_PokemonsByName: string[] = data.results.map( pokemon => pokemon.name);

  return {
    paths: All_PokemonsByName.map(name => ({ params: { name } })),
    fallback: 'blocking'
  }
}
